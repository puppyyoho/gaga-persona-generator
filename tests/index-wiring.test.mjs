...
assert.match(indexSource, /const currentApi = getCurrentApiStreaming\(liveContext\)/);
assert.match(indexSource, /const connection = currentApi \? null : getConnectionManagerStreaming\(liveContext\)/);
